...
# The data has been supplied in the form of vectors. You will have to create the two matrices
# before you proceed with the analysis.

#Dear Student,
#
#Welcome to the data set for the homework exercise.
#
#Instructions for this data set:
...
#Copyright: These data sets were prepared using publicly available data.
...
#Matrix
Free.Throws <- rbind(KobeBryant_FT, JoeJohnson_FT, LeBronJames_FT, CarmeloAnthony_FT, DwightHoward_FT, ChrisBosh_FT, ChrisPaul_FT, KevinDurant_FT, DerrickRose_FT,DwayneWade_FT)
...
# Removing row names
# rownames(Free.Throws) <- NULL
# Removing column names
# colnames(Free.Throws) <- NULL
...
#Matrix
Free.Throws.Attempts <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA,DwayneWade_FTA)
...
rownames(Free.Throws.Attempts)
colnames(Free.Throws.Attempts)
